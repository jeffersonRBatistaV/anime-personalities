...
```bash
npx skills add jeffersonRBatistaV/anime-personalities
```
...
¿Tu personaje favorito no está? Crea una carpeta `skills/<nombre>/SKILL.md` con el mismo formato y abre un PR.
